...
if (isset($_POST["submit"])) {
  if (!empty($_POST["user_email"]) && !empty($_POST["pwd"])) {
    ...
    $sql = "Select * from learners where learners_email = '" . $email . "' ";
      ...
      <div class="row justify-content-center">
        <div class="col-lg-6">
          <div class="card shadow-lg">
            <div class="card-body">
              <h4>Sign in to account - Learners</h4>
              <hr class="my-3" />
              <form action="" method="post" id="login-form">
                ...
                <div class="input-group input-group-lg form-group">
                  ...
                  <input type="email " name="user_email" class="form-control rounded-0" value="<?php if (isset($_COOKIE["member_login"])) {
                ...
                <div class="input-group input-group-lg form-group">
                  ...
                  <input type="password" name="pwd" class="form-control rounded-0" placeholder="Enter Password" required />
                </div>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body ">
          <form action="includes/recoverPassword.inc.php" method="post">
            ...
            <span>
              <p>Enter your email to get your One-Time-Password</p>
            </span>
