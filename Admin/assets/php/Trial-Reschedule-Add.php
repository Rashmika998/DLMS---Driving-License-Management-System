...
$new_records = mysqli_query($link,"SELECT * FROM trial_result WHERE user_id ='".$user_id."'");
...
<div class="right_col" role="main">
    <div class="row justify-content-center wrapper">
        <div class="col-lg-10 bg-white p-4 pt-12">
            <h4 class="text-center font-weight-bold">Add Re-Schedule For Trial Exam</h4>
            <hr class="my-3" />
            <form action="Trial-Reschedule-Upload.php" method="POST" class="px-3 needs-validation" >
                ...
                <div class="form-group">
                    ...
                    <?php
                    if($one_row['resultA1'] == 'Fail' || $one_row['resultA'] == 'Fail'){
                    ?>
                    <div class="form-row">
                    ...
                    if($one_row['resultC1'] == 'Fail' || $one_row['resultC'] == 'Fail' || $one_row['resultCE'] == 'Fail'){
                    ?>
                    <div class="form-row">
                        <div class="form-group col-md-2">
                    ...
                    if($one_row['resultD1'] == 'Fail' || $one_row['resultD'] == 'Fail' || $one_row['resultDE'] == 'Fail'){
                       ?>
                    <div class="form-row">
                        <div class="form-group col-md-2">
                        <label style="color: blue;">Vehicle Class</label><br>
                    ...
                    if($one_row['resultG1'] == 'Fail' || $one_row['resultG'] == 'Fail'){
                    ?>
                    <div class="form-row">
                        <div class="form-group col-md-2">
                        <label style="color: blue;">Vehicle Class</label>
                ...
                <br>
                <div class="form-group">
                    <button class="btn btn-primary btn-lg btn-block myBtn" type="submit " name="submit">Re
                        Schedule</button>
                </div>
