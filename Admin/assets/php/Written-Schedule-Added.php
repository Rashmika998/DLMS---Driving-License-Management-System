...
<div class="right_col" role="main">
    <div class="row justify-content-center wrapper" style="padding-top: 200px;">
        <div class="col-lg-7 bg-white p-4">
            ...
            <p class="row justify-content-center" style="font-size: 20px;">New Schedule Added Succesfully!</p>
            <div class="row justify-content-center" style="padding-left: 15px;">

                <a href="written_exam_slip.php?user_id=<?php echo $user_id?>"><button
                type="button" class="btn btn-success">Upload Payment Receipt</button></a>      
                      </div>
            </div>
            </div>
