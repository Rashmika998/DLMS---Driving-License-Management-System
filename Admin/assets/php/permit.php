...
$pdf->SetFont('Arial', 'B', 14);
$pdf->Cell(0, 10, 'TEMPORARY DRIVING PERMIT', 0, 1, 'C');
...
$pdf->Cell(40, 8, 'Age', 0, 0, 'L');
$by = date('Y', strtotime($data_2['dob'])) + 0;
$yr = date("Y") + 0;
$age = $yr - $by;
$pdf->Cell(40, 8, $age, 0, 1, 'L');
...
$pdf->Image($filepath, 155, 65, 40, 50);
...
$pdf->SetFont('Arial', '', 12);
$pdf->Cell(0, 10, '  DETAILS OF TEMPORARY DRIVING PERMIT', 1, 1, 'L');
...
$pdf->SetLeftMargin(20);
$pdf->SetFont('Arial', '', 10);
$pdf->Cell(40, 8, 'Transaction Fee', 0, 0, 'L');
$pdf->Cell(40, 8, 'Paid', 0, 1, 'L');
...
$sql = "INSERT INTO permit(user_id,document) VALUES ($u_id,'" . addslashes($content) . "')";
