        ...
        <div class="col-lg-12 bg-white p-4 pt-12">
            <div class="row gutters-sm">
                <div class=" col-md-6 mb-3">
                    <h4 class="text-center font-weight-bold">Written Exam Added Schedules</h4>
                    <hr class="my-3" />
            ...
            $records = mysqli_query($db,"SELECT DISTINCT date FROM written_exam ORDER BY date ASC");
            while($data=mysqli_fetch_array($records)){
                ?>
                        <tr>
                            <td>
                                <a href="Prev-Written-One-Schedule.php?date=<?php echo $data['date']?>">
                                    <div style="font-size: 17px;">
                                        <?php echo $data['date'];?>&nbsp;&nbsp;<i class="fa fa-calendar"
                                            aria-hidden="true"></i>
                                        <p style="float: right;"><i class="fa fa-chevron-right" aria-hidden="true"></i>
                                        </p>
                                    </div>
                                </a>
