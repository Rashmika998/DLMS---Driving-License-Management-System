...
<div class="right_col" role="main">
    <div class="row justify-content-center wrapper" style="padding-top: 200px;">
        <div class="col-lg-7 bg-white p-4">
            ...
            <p class="row justify-content-center" style="font-size: 20px;">Admin Account Created Successfully!</p>
            <div class="row justify-content-center" style="padding-left: 15px;">
                <a href="Admin-Add.php"> <button type="button" class="btn btn-success row justify-center">Done</button></a>
            </div>
