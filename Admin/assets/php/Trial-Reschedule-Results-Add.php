...
<div class="right_col" role="main">
    <div class="row justify-content-center wrapper">
        <div class="col-lg-10 bg-white p-4 pt-12">
            <h4 class="text-center font-weight-bold">Re-Scheduled Information</h4>
            <hr class="my-3" />
            <div class="px-3 needs-validation">
                ...
                <div class="form-group">
                    ...
                    if($row_details['date1'] !=null && $row_details['date1'] != $d1 && ($row_result['resultA1'] == 'N/A' || $row_result['resultA'] == 'N/A')){
                    ?>
                    <div class="form-row">
                    ...
                    if($row_details['date2'] != null && $row_details['date2'] != $d1 && $row_result['resultB1'] == 'N/A'){
                    ?>
                    <div class="form-row">
                        <div class="form-group col-md-2">
                            <label style="color: blue;">Vehicle Class</label>
                    ...
                    if($row_details['date3'] != null && $row_details['date3'] != $d1 && $row_result['resultB'] == 'N/A'){
                    ?>
                    <div class="form-row">
                        <div class="form-group col-md-2">
                            <label style="color: blue;">Vehicle Class</label>
                    ...
                    if($row_details['date4'] != null && $row_details['date4'] != $d1 && ($row_result['resultC1'] == 'N/A' || $row_result['resultC'] == 'N/A' || $row_result['resultCE'] == 'N/A')){
                    ?>
                    <div class="form-row">
                        <div class="form-group col-md-2">
                    ...
                    if($row_details['date5'] != null && $row_details['date5'] != $d1 && ($row_result['resultD1'] == 'N/A' || $row_result['resultD'] == 'N/A' || $row_result['resultDE'] == 'N/A')){
                       ?>
                    <div class="form-row">
                        <div class="form-group col-md-2">
                            <label style="color: blue;">Vehicle Class</label><br>
                    ...
                    if($row_details['date6'] != null && $row_details['date6'] != $d1 && ($row_result['resultG1'] == 'N/A' || $row_result['resultG'] == 'N/A')){
                    ?>
                    <div class="form-row">
                        <div class="form-group col-md-2">
                            <label style="color: blue;">Vehicle Class</label>
                    ...
                    if($row_details['date7'] != null && $row_details['date7'] != $d1 && $row_result['resultJ']){
                    ?>
                    <div class="form-row">
                        <div class="form-group col-md-2">
                            <label style="color: blue;">Vehicle Class</label>
                    ...
                    <br>
                    <form class="px-3 needs-validation" method="POST" action="Trial-Reschedule-Results-Update.php?user_id=<?php echo $row_result['user_id']?>">
                        <div class="form-group">
                            ...
                            <br>
                            <?php
                    if($row['A1'] == 1 && $row_result['resultA1'] != 'Pass'){
                    ?>
                            <div class="form-row">
                                <div class="form-group col-md-2">
                                    <label style="color: blue;">Vehicle Class</label>
                                ...
                                <div class="form-group col-md-2">
                                    ...
                                    <input type="text" class="form-control" disabled
                                        value="<?php echo $row_result['attemptA1']?>">
                                </div>
                    ...
                    if($row['A'] == 1 && $row_result['resultA'] != 'Pass'){
                        ?>
                            <div class="form-row">
                                <div class="form-group col-md-2">
                                    <label style="color: blue;">Vehicle Class</label>
                                ...
                                <div class="form-group col-md-2">
                                    <label style="color: blue;">Attempt</label>
                                    <input type="text" class="form-control" disabled
                                        value="<?php echo $row_result['attemptA']?>">
                                </div>
                        ...
                        if($row['B1'] == 1 && $row_result['resultB1'] != 'Pass'){
                            ?>
                            <div class="form-row">
                                <div class="form-group col-md-2">
                                    <label style="color: blue;">Vehicle Class</label>
                                ...
                                <div class="form-group col-md-2">
                                    <label style="color: blue;">Attempt</label>
                                    <input type="text" class="form-control" disabled
                                        value="<?php echo $row_result['attemptB1']?>">
                                </div>
                            ...
                            if($row['B'] == 1 && $row_result['resultB'] != 'Pass'){
                                ?>
                            <div class="form-row">
                                <div class="form-group col-md-2">
                                    <label style="color: blue;">Vehicle Class</label>
                                ...
                                <div class="form-group col-md-2">
                                    <label style="color: blue;">Attempt</label>
                                    <input type="text" class="form-control" disabled
                                        value="<?php echo $row_result['attemptB']?>">
                                </div>
                            ...
                            <?php
                                ...
                                if($row['C1'] == 1 && $row_result['resultC1'] != 'Pass'){
                                    ?>
                            <div class="form-row">
                                <div class="form-group col-md-2">
                                    <label style="color: blue;">Vehicle Class</label>
                                ...
                                <div class="form-group col-md-2">
                                    <label style="color: blue;">Attempt</label>
                                    <input type="text" class="form-control" disabled
                                        value="<?php echo $row_result['attemptC1']?>">
                                </div>
                            ...
                            <?php
                                    ...
                                    if($row['C'] == 1 && $row_result['resultC'] != 'Pass'){
                                        ?>
                            <div class="form-row">
                                <div class="form-group col-md-2">
                                    <label style="color: blue;">Vehicle Class</label>
                                ...
                                <div class="form-group col-md-2">
                                    <label style="color: blue;">Attempt</label>
                                    <input type="text" class="form-control" disabled
                                        value="<?php echo $row_result['attemptC']?>">
                                </div>
                            ...
                            <?php
                                        ...
                                        if($row['CE'] == 1 && $row_result['resultCE'] != 'Pass'){
                                            ?>
                            <div class="form-row">
                                <div class="form-group col-md-2">
                                    <label style="color: blue;">Vehicle Class</label>
                                ...
                                <div class="form-group col-md-2">
                                    <label style="color: blue;">Attempt</label>
                                    <input type="text" class="form-control" disabled
                                        value="<?php echo $row_result['attemptCE']?>">
                                </div>
                            ...
                            <?php
                                            ...
                                            if($row['D1'] == 1 && $row_result['resultD1'] != 'Pass'){
                                                ?>
                            <div class="form-row">
                                <div class="form-group col-md-2">
                                    <label style="color: blue;">Vehicle Class</label>
                                ...
                                <div class="form-group col-md-2">
                                    <label style="color: blue;">Attempt</label>
                                    <input type="text" class="form-control" disabled
                                        value="<?php echo $row_result['attemptD1']?>">
                                </div>
                            ...
                            <?php
                                    ...
                                    if($row['D'] == 1 && $row_result['resultD'] != 'Pass'){
                                                    ?>
                            <div class="form-row">
                                <div class="form-group col-md-2">
                                    <label style="color: blue;">Vehicle Class</label>
                                ...
                                <div class="form-group col-md-2">
                                    <label style="color: blue;">Attempt</label>
                                    <input type="text" class="form-control" disabled
                                        value="<?php echo $row_result['attemptD']?>">
                                </div>
                            ...
                            <?php
                                    ...
                                    if($row['DE'] == 1 && $row_result['resultDE'] != 'Pass'){
                                        ?>
                            <div class="form-row">
                                <div class="form-group col-md-2">
                                    <label style="color: blue;">Vehicle Class</label>
                                ...
                                <div class="form-group col-md-2">
                                    <label style="color: blue;">Attempt</label>
                                    <input type="text" class="form-control" disabled
                                        value="<?php echo $row_result['attemptDE']?>">
                                </div>
                        ...
                        if($row['G1'] == 1 && $row_result['resultG1'] != 'Pass'){
                            ?>
                            <div class="form-row">
                                <div class="form-group col-md-2">
                                    <label style="color: blue;">Vehicle Class</label>
                                ...
                                <div class="form-group col-md-2">
                                    <label style="color: blue;">Attempt</label>
                                    <input type="text" class="form-control" disabled
                                        value="<?php echo $row_result['attemptG1']?>">
                                </div>
                        ...
                        if($row['G'] == 1 && $row_result['resultG'] != 'Pass'){
                           ?>
                            <div class="form-row">
                                <div class="form-group col-md-2">
                                    <label style="color: blue;">Vehicle Class</label>
                                ...
                                <div class="form-group col-md-2">
                                    <label style="color: blue;">Attempt</label>
                                    <input type="text" class="form-control" disabled
                                        value="<?php echo $row_result['attemptG']?>">
                                </div>
                        ...
                        if($row['J'] == 1 && $row_result['resultJ'] != 'Pass'){
                            ?>
                            <div class="form-row">
                                <div class="form-group col-md-2">
                                    <label style="color: blue;">Vehicle Class</label>
                                    <br><?php echo "J ";?><img src="Header/production/images/13.png">
                                </div>

                                <div class="form-group col-md-2">
                                    <label style="color: blue;">Attempt</label>
                                    <input type="text" class="form-control" disabled
                                        value="<?php echo $row_result['attemptJ']?>">
                                </div>
                    ...
                    ?>
                        ...
                        <div class="form-group">
                            <button class="btn btn-primary btn-lg btn-block myBtn" name="submit" type="submit">Update Result</button>
