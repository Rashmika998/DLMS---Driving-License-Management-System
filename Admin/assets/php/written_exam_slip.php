...
$pdf->SetFont('Arial', 'B', 14);
$pdf->Cell(0, 10, 'RECEIPT FOR PAYMENT', 0, 1, 'C');
...
$pdf->SetFont('Arial', '', 12);
$pdf->Cell(0, 10, '  WRITTEN TEST', 1, 1, 'L');
$pdf->ln(6);
$pdf->SetFont('Arial', '', 10);
$pdf->Cell(40, 8, 'Written Test Location', 0, 0, 'L');
$pdf->Cell(40, 8, $data_3['location'], 0, 1, 'L');

$pdf->Cell(40, 8, 'Written Test Date', 0, 0, 'L');
$pdf->Cell(40, 8, $data_3['date'], 0, 1, 'L');

$pdf->Cell(40, 8, 'Written Test Time', 0, 0, 'L');
$pdf->Cell(40, 8, $data_3['time'], 0, 1, 'L');
$pdf->ln(8);

$pdf->SetFont('Arial', '', 12);
$pdf->Cell(0, 10, '  DETAILS OF DRIVING LICENSE APPLICATION', 1, 1, 'L');


$pdf->SetFont('Arial', '', 11);
$pdf->Cell(0, 10, '  Driving License Class : ', 1, 1, 'L');
...
$pdf->SetLeftMargin(20);
$pdf->SetFont('Arial', '', 10);
$pdf->Cell(40, 8, 'Amount Paid', 0, 0, 'L');
$pdf->Cell(40, 8, $data_4['amount'], 0, 0, 'L');

$pdf->Cell(40, 8, 'Payment Reference', 0, 0, 'L');
$pdf->Cell(40, 8, $data_4['token'], 0, 1, 'L');
...
$sql = "INSERT INTO written_exam_slip(user_id,document) VALUES ($u_id,'" . addslashes($content) . "')";
