    ...
    <div class="container">
        <div class="card">
            <div class="card-header">
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="renewalmedical.php">Upload medical</a>
                </li>
            ...
            <div class="card-body">
                ...
                <?php
                        ...
                        if($status == NULL)
                        {
                            echo "<div class= 'alert alert-warning'>
                                <button type='button' class='close' data-dismiss='alert'>&times;</button>
                                <strong>Please upload a pdf of your medical to complete this step</strong>
                            </div>";
                            $condition='';
                        }
                        if($status == 'Pending')
                        ...
                        if($status == 'Rejected')
                        {
                            echo "<div class= 'alert alert-danger'>
                                <button type='button' class='close' data-dismiss='alert'>&times;</button>
                                <strong>Your pdf of medical has been rejected! Please upload a clear pdf of your medical again to complete this step</strong>
                            </div>";
                        }
                ...
                <form class="uploader" action="renewalmedical.inc.php" method="post" enctype="multipart/form-data" >
                <?php 
