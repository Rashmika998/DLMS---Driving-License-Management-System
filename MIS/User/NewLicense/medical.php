...
while ($row = mysqli_fetch_assoc($result)) 
{
    ...
    if( $row["nic_copy"]== NULL  || $row["user_photo"]== NULL || $row["birth_certificate"]== NULL)
    {
    ...
    <div class="container">
        <div class="card">
            <div class="card-header">
                ...
                <li class="nav-item">
                    <a class="nav-link  active" href="medical.php">Upload medical certificate</a>
                </li>
                <li class="nav-item">
            ...
            <div class="card-body">
                <h5 class="card-title">Upload your medical here</h5>
                <p class="card-text">
                <?php
                        if($_SESSION['update']==0)
                        {
                        ...
                        if($status == NULL)
                        {
                            echo "<div class= 'alert alert-info'>
                                <button type='button' class='close' data-dismiss='alert'>&times;</button>
                                <strong>Please upload your medical to complete this step</strong>
                            </div>";
                            $condition='';
                        }
                        if($status == 'Pending')
                        {
                            echo "<div class= 'alert alert-info'>
                                <button type='button' class='close' data-dismiss='alert'>&times;</button>
                                <strong>This form is disabled, You have successfully uploaded your medical!<br>".$allset,$msg1,$msg2,$msg3."</strong>
                            </div>";
                        }
                        if($status == 'Rejected')
                        {
                            echo "<div class= 'alert alert-danger'>
                                <button type='button' class='close' data-dismiss='alert'>&times;</button>
                                <strong>Document rejected! Please upload your medical again to complete this step</strong>
                            </div>";
                        }
                ...
                ?>
                    ...
                    <ul>
                        ...
                        <li>Doctor's seal and signature should be visible.</li>
                        <li>All pages should be included in one file.</li>
                        <li>Forged documents will be rejected.</li>
                    </ul>
                </p>
                <form class="uploader" action="medical.inc.php" method="post" enctype="multipart/form-data" >
                <?php 
