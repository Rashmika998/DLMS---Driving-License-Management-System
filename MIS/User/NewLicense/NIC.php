    ...
    <div class="container">
        <div class="card">
            <div class="card-header">
                ...
                <li class="nav-item">
                    <a class="nav-link  active" href="NIC.php">Upload a copy of your National Identity Card</a>
                </li>  
                </ul>
            </div>
            <div class="card-body">
                <h5 class="card-title">Upload a copy of your National Identity Card here</h5>
                <p class="card-text">
                <?php
                        if($_SESSION['update']==0)
                        {
                ...
                ?>
                    ...
                    <ul>
                        ...
                        <li>Both sides of the NIC should include in that <span translate="no">pdf</span>.</li>
