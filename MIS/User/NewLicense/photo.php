...
while ($row = mysqli_fetch_assoc($result)) 
{
    ...
    if( $row["nic_copy"]== NULL  || $row["birth_certificate"]== NULL || $row["medical"]== NULL)
    {
        $allset= "Looks like you still haven't upload your: <br>";
    }
    if( $row["birth_certificate"]== NULL)
    {
        $msg1="<li><a href='birthCertificate.php'>A copy of birth certificate</a></li>";
    }
    if( $row["medical"]== NULL)
    {
    ...
    <div class="container">
        <div class="card">
            <div class="card-header">
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="photo.php">Upload photo</a>
                </li>
                <li class="nav-item">
            ...
            <div class="card-body">
                ...
                <form class="uploader" action="photo.inc.php" method="post" enctype="multipart/form-data" >
                <?php 
