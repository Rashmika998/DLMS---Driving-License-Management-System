...
if($amount == 1700 || $amount == 2000 || $amount == 2250){
    ...
    if($_SESSION['update']==1)
    {
        ...
        mysqli_stmt_bind_param($stmt,"isi",$id ,$token,$amount);
        ...
        mysqli_stmt_bind_param($stmt,"siiss",$token,$id ,$amount, $dt,$Description);
        mysqli_stmt_execute($stmt);
        mysqli_stmt_close($stmt);
    ...
    else if($_SESSION['update']==2)
    {
        ...
        mysqli_stmt_bind_param($stmt,"issssi",$amount,$dt,$paid,$scheduled,$attempt,$id);
        mysqli_stmt_execute($stmt);
        mysqli_stmt_close($stmt);
            ...
            mysqli_stmt_bind_param($stmt,"ssi",$attempt,$newResult,$id);
            mysqli_stmt_execute($stmt);
            mysqli_stmt_close($stmt);
